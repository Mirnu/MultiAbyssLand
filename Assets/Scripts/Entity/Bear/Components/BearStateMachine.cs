...
namespace Assets.Scripts.Entity.Bear 
{
    ...
    public class BearStateMachine : EntityStateMachine
    {
        [SerializeField] public  BearAttackState AttackState;
        [SerializeField] public  BearSearchState SearchState;
        [SerializeField] public  BearHitState HitState;
